...
Most important thing is to understand the git's concept and basic terminology, if not, it's not easy to soak into git world.
...
[[./git-term.png]]
  ...
  |                 | master: normally your own branch                                                                                         |
